  ...
  <div class="app-container">
    ...
    <div class="tanchuang" v-show="tanchuang">
      <div class="biaoge">
        ...
        <div>
          <div>
            <p class="p-size">图片尺寸(1920*478)</p>
            <el-upload
...
export default {
  ...
  methods: {
    ...
    // 获取列表信息
    listinfo() {
      this.axios.get(this.Globle.baseURL+"getGroup?tag=1").then(res => {
        // console.log(res)
